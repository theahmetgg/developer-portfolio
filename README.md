...
```bash
git clone https://github.com/theahmetgg/developer-portfolio
cd portfolio
```
...
export const testimonials = [
  {
    quote:
      "Collaborating with Ahmet was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Ahmet's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Ahmet is the ideal partner.",
